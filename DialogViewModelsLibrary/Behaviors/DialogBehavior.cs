...
using DevTrustDemo.ViewModels.Interfacees;
using DevTrustDemo.ViewModels.Interfaces;
using System;
...
namespace DialogViewModelsLibrary.Behavior
{
    public static class DialogBehavior
    {
        ...
        private static void AddDialog(IDialogViewModel viewModel, ObservableCollection<IDialogViewModel> collection, Window owner)
        {
            ...
            try {
                ...
                // ErrorLog.WriteErrorLog($"Exception: {ex}", "AddDialog()", null, $"Unable to open view. ViewModel name: {viewModel}");
            }
